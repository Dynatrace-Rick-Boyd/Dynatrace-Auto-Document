...
<head>
	...
	<link rel="stylesheet" href="CSS\systemProfile.css" />
...
<div id="quickLinks" class="columns">
	...
	<div class="rightColumn">
		<xsl:choose>
			<!--displays an image of the dT splashscreen.  Currently only 5.5 through 4.2 is configured-->
			<xsl:when test="starts-with(/dynatrace/@version,'5.6')" >
				<a href="https://apmcommunity.compuware.com/community/display/DOCDT56/dynaTrace+Documentation"><img id="dynaTraceImage" src="Images\dynaTraceSplash56.png" /></a>
			</xsl:when>
			<xsl:when test="starts-with(/dynatrace/@version,'5.5')" >
				<a href="https://apmcommunity.compuware.com/community/display/DOCDT55/dynaTrace+Documentation"><img id="dynaTraceImage" src="Images\dynaTraceSplash55.png" /></a>
			</xsl:when>
			<xsl:when test="starts-with(/dynatrace/@version,'5.0')" >
				<a href="https://apmcommunity.compuware.com/community/display/DOCDT50/dynaTrace+Documentation"><img id="dynaTraceImage" src="Images\dynaTraceSplash50.png" /></a>
			</xsl:when>
			<xsl:when test="starts-with(/dynatrace/@version,'4.2')" >
				<a href="https://apmcommunity.compuware.com/community/display/DOCDT42/dynaTrace+Documentation"><img id="dynaTraceImage" src="Images\dynaTraceSplash42.png" /></a>
			</xsl:when>
		</xsl:choose>
	</div>
</div>
...
<div id="errors" >
	...
	<ol>
		<li><img src="Images\errordetection_error.png" />The detected error is simply detected as error but does not have further consequences</li>
		<li><img src="Images\errordetection_error_transaction_failed.png" />The detected error is simply detected as error but does not have further consequences</li>
		<li><img src="Images\errordetection_error_pageaction_failed.png" />The detected error is simply detected as error but does not have further consequences</li>
	</ol>
